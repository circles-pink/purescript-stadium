...
-- class GetState :: StateMachine -> Row Type -> Constraint
-- class GetState stm r | stm -> r

-- instance getState :: (GetState' stm r) => GetState (MkStateMachine stm) r
...
-- instance getState'Nil :: GetState' Empty ()

-- instance getState'Rec ::
--   ( GetState' stm' r'
--   , Cons sn st r' r
--   ) =>
...
--   , Filter st (sn :> Nil') st'
--   ) =>
--   GetOriginState stm (MkStateName sn) st'
...
--   ( GetState stm st
--   , GetAction stm (MkStateName sn) (MkActionName an) (MkAction at ts)
--   , Filter st (sn :> Nil') st'
--   ) =>
--   GetTargetState stm (MkStateName sn) (MkActionName an) st'
...
-- instance getAction ::
--   ( Lookup stm sn (MkState st (MkStateActions sa))
--   , Lookup sa an a
--   ) =>
--   GetAction (MkStateMachine stm) sn an a

-- testsGetAction :: Unit
-- testsGetAction =
--   fold
--     [ let
--         test :: forall a1 a2 a3 a4. GetAction a1 a2 a3 a4 => Test4 a1 a2 a3 a4
--         test = test4
--       in
--         fold
--           [ test
